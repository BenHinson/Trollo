...
export default function Board() {
  const [columns, setColumns] = useState(["column1", "column2", "column3", "column4"])
  ...
  return (
    <div>
      <h2>Project Name</h2>
      <div>
        <input placeholder="add column" value={newColumnName} onChange={(e) => setNewColumnName(e.target.value)}></input>
